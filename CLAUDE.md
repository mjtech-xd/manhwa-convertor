...
**Left**
- *Phase 6 polish:* `MessageChannelMain` IPC streaming; IndexedDB filtered-image cache; p95 chapter <60 s. (Gemini prompt-response LRU done.)
