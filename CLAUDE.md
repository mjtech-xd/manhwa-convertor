...
**Left**
- *Phase 6 polish:* `MessageChannelMain` IPC streaming; p95 chapter <60 s. (Gemini prompt-response LRU + IndexedDB filtered-image cache done.)
