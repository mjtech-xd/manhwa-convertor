...
**Left**
- *Phase 6 polish:* hit p95 chapter <60 s; worker-level streaming + backpressure (current streaming is at the IPC boundary only). (Gemini prompt-response LRU + IndexedDB filtered-image cache + `MessageChannelMain` IPC streaming done.)
